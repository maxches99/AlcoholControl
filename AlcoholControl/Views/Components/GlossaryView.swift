    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                term("Пик BAC", "Максимальное оценочное значение BAC за сессию.")
                ...
                term("План перед началом", "План до начала вечера: лимит алкоголя, цель воды и ориентир времени завершения.")
                term("Режим безопасности", "Более осторожный режим: ранние напоминания о паузах, воде и быстром переходе к действиям безопасности.")
                term("Кризисный режим", "Режим срочной помощи: быстрый доступ к экстренным действиям и контакту доверенного человека.")
                term("Умные напоминания", "Напоминания, которые учитывают текущий риск, а не только фиксированный интервал.")
                term("План восстановления (2-4ч)", "Короткий персонализированный план восстановления после сессии с отметкой выполненных шагов.")
                term("Паттерны триггеров", "Повторяющиеся дни, время и типы напитков, которые чаще связаны с тяжелым утром.")
                term("Недельные цели harm-reduction", "Недельные лимиты по рискам и цель гидратации для контроля прогресса.")
                term("Серия", "Серия сессий подряд, где вы держите полезную привычку, например воду или прием пищи.")
